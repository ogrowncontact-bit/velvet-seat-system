...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SeatFlow is the premium reservation, floor plan and guest CRM platform for ambitious restaurants. Reduce no-shows, automate WhatsApp confirmations, and orchestrate every service." },
      ...
      { name: "twitter:site", content: "@seatflow" },
    ],
    links: [
